        ...
        <div className="mx-auto max-w-[1100px]">
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <p className="mt-4 leading-7 text-zinc-600 dark:text-zinc-400">Tutor profiles and booking are opening soon. Join the early-access list by choosing what you need help with.</p>
            </div>
